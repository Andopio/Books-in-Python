...
nodeA = Book("Title: The Land Before,","Author:Wellington Higgenbottom,","Genre: Scifi, Length: 10 pages",)
nodeB = Book("Title: Woopty Doo,","Author: Geaorge Bush,","Genre: Childrens, Length: 1 page",)
nodeC = Book("Title: Doopty Who,","Author: Joe Biden,","Genre: Pre-teen, Length: 2 pages",)
nodeD = Book("Title: Game Over,","Author: Hillary Clinton,","Genre: Fiction, Length: 5 pages",)
nodeE = Book("Title: Game Start,","Author: Clint Eastwood,","Genre: Western, Length: 1000 pages",)
nodeF = Book("Title: The End,","Author: Nicholas Cage,","Genre: Auto-Biography, Length: 12 pages",)
